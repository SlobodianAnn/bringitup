...
/* harmony import */ var _modules_listDifference__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/listDifference */ "./src/js/modules/listDifference.js");
...
window.addEventListener('DOMContentLoaded', function () {
  try {
    ...
    feedSlider.init();
    var videoPlayer = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_1__["default"]('.showup .play', '.overlay', '.close');
    videoPlayer.init();
    new _modules_listDifference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officer__card-item').init();
    new _modules_listDifference__WEBPACK_IMPORTED_MODULE_3__["default"]('.officernew', '.officer__card-item').init();
    new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form').init();
  } catch (e) {}

  var moduleInfo = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DownloadBtn; });
...
/*#__PURE__*/
function () {
  function DownloadBtn(triggerSelector, pathFile) {
    _classCallCheck(this, DownloadBtn);

    this.triggers = _toConsumableArray(document.querySelectorAll(triggerSelector));
    this.pathFile = pathFile;
  }

  _createClass(DownloadBtn, [{
    key: "createLink",
    value: function createLink(path) {
    ...
    value: function init() {
      ...
      this.triggers.forEach(function (btn) {
        btn.addEventListener('click', function () {
          ...
          _this.createLink(_this.pathFile);
        });
      });
    }
  }]);
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "createMessage",
    value: function createMessage(item) {
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          _this.createMessage(item);

          var formData = new FormData(item);

          try {
            _this.postData(_this.path, formData);

            console.log(res);
            _this.statusMessage.textContent = _this.message.success;
          } catch (_unused) {
            _this.statusMessage.textContent = _this.message.failure;
          } finally {
            _this.clearInputs();

            setTimeout(function () {
              _this.statusMessage.remove();
            }, 6000);
          }
        });
      });
...
/***/ "./src/js/modules/listDifference.js":
/*!******************************************!*\
  !*** ./src/js/modules/listDifference.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ListDifference; });
...
/*#__PURE__*/
function () {
  function ListDifference(columnSelector, cardsSelector) {
    _classCallCheck(this, ListDifference);
  ...
  _createClass(ListDifference, [{
    key: "bindTriggers",
    value: function bindTriggers() {
      var _this = this;

      this.column.querySelector('.plus').addEventListener('click', function () {
        if (_this.columnCounter !== _this.columnCards.length - 2) {
          _this.columnCards[_this.columnCounter].style.display = 'flex';
          _this.columnCounter++;
        } else {
          _this.columnCards[_this.columnCounter].style.display = 'flex';

          _this.columnCards[_this.columnCards.length - 1].remove();
        }
      });
    }
  }, {
    ...
    value: function hideItems() {
      this.columnCards.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggerSelector, overlaySelector, closeSelector) {
    _classCallCheck(this, VideoPlayer);

    this.btns = _toConsumableArray(document.querySelectorAll(triggerSelector));
    this.overlay = document.querySelector(overlaySelector);
    this.close = this.overlay.querySelector(closeSelector);
...
function () {
  function ShowInfo(triggers) {
    ...
    this.btns = _toConsumableArray(document.querySelectorAll(triggers));
  }
...
function (_Slider) {
  ...
  function MainSlider(triggersNextSelector, triggersPrevSelector) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, triggersNextSelector, triggersPrevSelector));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.triggersNext.forEach(function (trigger) {
        trigger.addEventListener('click', function (e) {
          e.preventDefault();

          _this.plusSlides(1);
        });
        trigger.parentNode.previousElementSibling.addEventListener('click', function (e) {
          e.preventDefault();
          _this.slideIndex = 1;
      ...
      this.triggersPrev.forEach(function (trigger) {
        trigger.addEventListener('click', function (e) {
          e.preventDefault();
    ...
    key: "showPopup",
    value: function showPopup(blockSelector, n) {
      var _this2 = this;
      ...
      if (n === 3) {
        ...
        setTimeout(function () {
          ...
          _this2.popup.classList.add('slideInUp');
        }, 3000);
      } else {
...
function (_Slider) {
  ...
  function MiniSlider(blockSelector, nextSelector, prevSelector, activeClass, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, blockSelector, nextSelector, prevSelector, activeClass, animate, autoplay));
  }
  ...
  _createClass(MiniSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.next.addEventListener('click', function () {
        _this2.block.appendChild(_this2.slides[0]);
      ...
      this.prev.addEventListener('click', function () {
        ...
        _this2.block.insertBefore(active, _this2.slides[0]);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$triggersNextSele = _ref.triggersNextSelector,
      triggersNextSelector = _ref$triggersNextSele === void 0 ? null : _ref$triggersNextSele,
      _ref$triggersPrevSele = _ref.triggersPrevSelector,
      triggersPrevSelector = _ref$triggersPrevSele === void 0 ? null : _ref$triggersPrevSele,
      _ref$nextSelector = _ref.nextSelector,
      nextSelector = _ref$nextSelector === void 0 ? null : _ref$nextSelector,
      _ref$prevSelector = _ref.prevSelector,
      prevSelector = _ref$prevSelector === void 0 ? null : _ref$prevSelector,
  ...
  this.triggersNext = _toConsumableArray(document.querySelectorAll(triggersNextSelector));
  this.triggersPrev = _toConsumableArray(document.querySelectorAll(triggersPrevSelector));
